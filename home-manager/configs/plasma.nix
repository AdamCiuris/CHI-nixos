{ inputs, outputs, lib, config, pkgs, ... }: 
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-4528a9a3-380e-4f28-ae25-a53b416fbe8b" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."4528a9a3-380e-4f28-ae25-a53b416fbe8b" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "4528a9a3-380e-4f28-ae25-a53b416fbe8b";
      "kcminputrc"."Mouse"."X11LibInputXAccelProfileFlat" = true;
      "kcminputrc"."Mouse"."cursorTheme" = "Win11-black-dark";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{c84ea164-51db-48c3-b484-0d5e676366d5}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{ec37af8d-6047-418b-9455-f2c42966d265}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{d6413c8a-cdfc-4afc-bf35-546b622e4cc2}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{27ed3eb2-fbc1-445c-943e-b5b42a7131b4}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{f3f0be08-dbc1-4359-86f4-97da75d1870c}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{4a41207f-566d-4fe0-818c-2912a429a639}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{9f461212-2311-43ee-9c2d-b13da79b49e7}";
      ...
      "kwinrc"."Desktops"."Id_1" = "b6622380-d328-4ed4-8c2e-47cf8a13b2c1";
      ...
      "plasmarc"."Theme"."name" = "Windows11-Nord";
    };
  };
}